  ...
  <div data-collapse="small" data-animation="default" data-duration="400" class="navbar w-nav">
    ...
    <div class="container w-container">
      <div class="w-full flex flex-row">
        ...
        <img class="inline-block mb-1 " width="24" height="24" src="/images/ethdiamond.jpeg" />
        </div>
        <router-link to="/" class='no-underline flex-grow inline text-xl text-gray-900 font-bold'>Shadow Super Coder</router-link>
       </div>
